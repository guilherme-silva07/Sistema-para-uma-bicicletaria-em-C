...
void menu(){
  ...
  FILE *arq_bicicleta;
	...
	while(1){
		...
		printf("\n1- Cadastrar produtos ");//Arthur
		printf("\n2- Mostrar todos os produtos");//Felipe
		printf("\n3- Mostrar produtos por grupo");//Felipe
    printf("\n4- Editar produtos");//Arthur
    printf("\n5- Cadastrar clientes");//Arthur
    printf("\n6- Mostrar todos os clientes");//Felipe
    printf("\n7- Mostrar cliente especifico");//Felipe
    printf("\n8- Editar clientes");//Arthur
    printf("\n9- Alugar bicicletas"); //Guilherme (abre_arquivo) (fecha_arquivo)
    printf("\n10- Devolver bicicletas"); //Guilherme
		printf("\n0- Sair");
		printf("\nDigite opcao: ");
      scanf("%d", &opcao);
      setbuf(stdin, NULL);
